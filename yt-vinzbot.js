...
const isRegistered = checkRegisteredUser(sender)
   const isRegister = register.includes(sender)
    ...
    const totalhit = JSON.parse(fs.readFileSync("./lib/totalcmd.json"))[0]
      ...
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan Bot follow dlu kak https://instagram.com/haikalrizkiiii_\nhabis follow ketik Verify  Ya kak `
...
cmhit.push(command)
    //MESS
    mess = {
        noregis: "follow dlu kak https://instagram.com/haikalrizkiiii_\nhabis follow ketik #daftar",
...
🐥 IG Bot: https://instagram.com/haikalrizkiiii_
...
vinz.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', quoted: fg3, ptt: true })
        break
case 'allmenu': 
ptod = "6289696454872@s.whatsapp.net"
stod = `${sender}`
       stst = await vinz.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = 'ALLMENU'
...
🐥 *𝐘𝐭 𝐁𝐨𝐭 :*https://instagram.com/haikalrizkiiii_
🐥 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
🐥 𝐀𝐜𝐭𝐢𝐯𝐞 : *${runtime(process.uptime())}*
🐥 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *android*
...
case 'ytgw':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
  reply('nih jan lupa follow ig owner bot 😗 https://instagram/haikalrizkiiii_')
break
        		        case 'darkneon':
			case 'woodblock':
			case 'paper':
